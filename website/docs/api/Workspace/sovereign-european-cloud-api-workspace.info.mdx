---
id: sovereign-european-cloud-api-workspace
title: "Sovereign European Cloud API - Workspace"
description: "The Workspace API provides access to resources that are specific to a tenant's workspace."
...
<Heading
  ...
  children={"Sovereign European Cloud API - Workspace"}
>
</Heading>
