---
id: sovereign-european-cloud-api-authorization
title: "Sovereign European Cloud API - Authorization"
description: "The Authorization API provides access to authorization resources"
...
<Heading
  ...
  children={"Sovereign European Cloud API - Authorization"}
>
</Heading>
