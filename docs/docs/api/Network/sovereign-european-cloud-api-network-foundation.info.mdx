---
id: sovereign-european-cloud-api-network-foundation
title: "Sovereign European Cloud API - Network Foundation"
description: "The Network Foundation API provides access to network resources, including LANs, NICs, security groups, subnets, and routing tables."
...
<Heading
  ...
  children={"Sovereign European Cloud API - Network Foundation"}
>
</Heading>
